...
// CVwGraph
IMPLEMENT_DYNAMIC(CVwGraph, CWnd)
CVwGraph::CVwGraph()
{
	m_nTrendXPos = -1;
	m_nTrendShiftCnt = 0;
	m_clBase = RGB(232, 232, 232);
...
BEGIN_MESSAGE_MAP(CVwGraph, CWnd)
	ON_WM_PAINT()
...
///////////////////////////////////////////////////////////////////////////////
// CVwGraph message handler

int CVwGraph::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CVwGraph::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
	CClientDC dc(this);
...
LRESULT CVwGraph::OnAppendTrend(WPARAM wParam, LPARAM lParam)
{
	CClientDC	dc(this);
	CDC			memDC;
	CBitmap		*oldBitmap;
...
LRESULT CVwGraph::OnRedrawTrend(WPARAM wParam, LPARAM lParam)
{
	CClientDC	dc(this);
	CRect		rcPaint;
	CDC			memDC;
...
void CVwGraph::OnLButtonDown(UINT nFlags, CPoint point)
{
	CClientDC	dc(this);
...
void CVwGraph::OnMouseMove(UINT nFlags, CPoint point)
{
	CClientDC	dc(this);
...
void CVwGraph::OnLButtonUp(UINT nFlags, CPoint point)
{
	CClientDC	dc(this);
...
BOOL CVwGraph::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message)
{
...
///////////////////////////////////////////////////////////////////////////////
// CVwGraph member function(protected)

// PAINT message proc
void CVwGraph::GraphPaint(CDC &dc)
{
...
void CVwGraph::ClearTrendWave(CDC &dc)
{
	int	x, y;
	CPoint	linePoint[2];
	CRect	rc;
...
void CVwGraph::DrawTrendWave(CDC &dc, int color, int cmd, int yPos)
{
	POINT	linePoint[2];
...
// shift the window.
void CVwGraph::ShiftTrendWave(CDC &dc)
{
...
///////////////////////////////////////////////////////////////////////////////
// CVwGraph member function(public)

void CVwGraph::AppendTrend(	double dOrdPattOut, double dAlmPattOut, 
...
void CVwGraph::RedrawTrend(void)
{
